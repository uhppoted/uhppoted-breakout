...
const struct I2C U2 = {
    .bus = i2c1,
    .addr = 0x40, // 0x20 << 1 (because that is how the addressing works)
};

// U3 PCAL6408A
const struct I2C U3 = {
    .bus = i2c0,
    .addr = 0x42, // 0x21 << 1 (because that is how the addressing works)
};
...
const struct I2C U5 = {
    .bus = i2c0,
    .addr = 0x64, // 0x32 << 1 (because that is how the addressing works)
};
