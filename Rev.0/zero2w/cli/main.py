...
def parse_args():
    ...
    get_controller.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    get_status.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    get_listener.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-listener
    set_listener = parsers['set-listener']
    set_listener.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    open_door.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... get-cards
    get_cards = parsers['get-cards']
    get_cards.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    get_card_by_index.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    delete_card.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... delete-all-cards
    delete_all_cards = parsers['delete-all-cards']
    delete_all_cards.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... get-event-index
    get_event_index = parsers['get-event-index']
    get_event_index.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-event-index
    set_event_index = parsers['set-event-index']
    set_event_index.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... get-event
    get_event = parsers['get-event']
    get_event.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... record-special-events
    record_special_events = parsers['record-special-events']
    record_special_events.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... get-time-profile
    get_time_profile = parsers['get-time-profile']
    get_time_profile.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-time-profile
    set_time_profile = parsers['set-time-profile']
    set_time_profile.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... clear-time-profiles
    clear_time_profiles = parsers['clear-time-profiles']
    clear_time_profiles.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    refresh_tasklist.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... clear-tasklist
    clear_tasklist = parsers['clear-tasklist']
    clear_tasklist.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-pc-control
    set_pc_control = parsers['set-pc-control']
    set_pc_control.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-interlock
    set_interlock = parsers['set-interlock']
    set_interlock.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... activate-keypads
    activate_keypads = parsers['activate-keypads']
    activate_keypads.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')

    # ... set-door-passcodes
    set_door_passcodes = parsers['set-door-passcodes']
    set_door_passcodes.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
    ...
    restore_default_parameters.add_argument('--controller', type=int, default=CONTROLLER, help='controller serial number, e.g. 405419896')
