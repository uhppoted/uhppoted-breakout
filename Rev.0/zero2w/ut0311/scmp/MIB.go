...
var OID_CONTROLLER_SYSERR = OID{1, 3, 6, 1, 4, 1, 65536, 2, 9}

var OID_CONTROLLER_SYSINFO = OID{1, 3, 6, 1, 4, 1, 65536, 2, 10}
...
var OID_EVENTS_INDEX = OID{1, 3, 6, 1, 4, 1, 65536, 6, 0, 4}
